...
function CourseList() {
  const [data, setData] = useState({ courseId: "", courseName: "" });
    ...
    <div className="container">
      <div className="row mt-5 text-center">
        <div className="col-sm-5 m-auto">
          ...
          <Form onSubmit={submitHandler} style={{borderRadius:'10px', backgroundColor:'#af52ad', padding:'8px'}}>
      ...
      <div className='row mt-5 '>
        <div className="col-sm-6 m-auto text-center p-3">
            ...
            <Table bordered responsive hover style={{backgroundColor:'#af52ad'}}>
                <thead>
                    <tr>
                        <th>Sno</th>
                        <th>CourseId</th>
                ...
                <tbody>
                    {
                        courseListData.length > 0? courseListData.map((course,index) =>(
                            <tr key={index}>
                                <td>{index + 1}</td>
